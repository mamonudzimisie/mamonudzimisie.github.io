...
const groups: {
...
}[] = [
  {
    audience: 'dzieci',
    label: 'Dla dzieci',
    description: 'Zagadki i łamigłówki dopasowane do wieku dziecka — przyjemny sposób na naukę i rozwój koncentracji.',
    Icon: IconKid,
  ...
  },
  {
    audience: 'dorosli',
    label: 'Dla dorosłych',
    description: 'Łamigłówki logiczne i liczbowe dla dorosłych. Od formy relaksu po prawdziwe wyzwania umysłowe.',
    Icon: IconAdult,
  ...
  },
  {
    audience: 'duzy-druk',
    label: 'Duży druk',
    description: 'Wygodna, czytelna czcionka — z myślą o osobach z trudnościami w czytaniu drobnego tekstu.',
    Icon: IconLargePrint,
